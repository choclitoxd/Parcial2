...
public class ModelFactory {
    ...
    private void inicializarDatos() {
        ...
        Prestamo prestamo1 = Prestamo.builder()
                .numeroPrestamo("1")
                .fechaPrestamo(new Date(fechaHoy.getYear(),02,28))
        ...
        Prestamo prestamo2 = Prestamo.builder()
                .numeroPrestamo("2")
                .fechaPrestamo(new Date(fechaHoy.getYear(),4,28))
        ...
        Prestamo prestamo3 = Prestamo.builder()
                .numeroPrestamo("3")
                .fechaPrestamo(new Date(fechaHoy.getYear(),04,29))
        ...
        Prestamo prestamo4 = Prestamo.builder()
                .numeroPrestamo("4")
                .fechaPrestamo(new Date(fechaHoy.getYear(),01,28))
        ...
        Prestamo prestamo5 = Prestamo.builder()
                .numeroPrestamo("5")
                .fechaPrestamo(new Date(fechaHoy.getYear(),04,20))
    ...
    public String objetosMenosPrestados(int rango){
        return prestamoUq.objetosMenosPrestados(rango);
    }
    ...
    public String obtenerClientePorCedula(String cedula) {
        return prestamoUq.obtenerClientePorCedula(cedula);
    }

    public String empleadosConMasPrestamos(String rango) {
        return prestamoUq.prestamosConMasPrestamos(rango);
    }

    public String obtenerPrestamosFecha(String fecha) {
        return prestamoUq.obtenerPrestamosFecha(fecha);
    }

    public String EntreDosFechas(String fechaIni, String finalText) {
        return prestamoUq.EntreDosFechas(fechaIni, finalText);
    }
}
